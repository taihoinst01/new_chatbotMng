...
function(a) {
    ...
    h.prototype.toggle = function(a, b) {
        ...
        /**2018.11.8 LUIS메뉴 하위에 앱이 여러개있을 경우 첫번째 제외한 treeview-menu 안보이는 문제 해결 */
        if (b.parent().children(e.treeviewMenu).length > 1) {
            for (var tm=1; tm<b.parent().children(e.treeviewMenu).length; tm++) { 
                b.parent().children(e.treeviewMenu).eq(tm).slideDown(this.options.animationSpeed, function() {
                    a(this.element).trigger(d)
                }.bind(this))
            }
        }
        ...
        if (b.parent().children(e.treeviewMenu).length > 1) {
            for (var tm=1; tm<b.parent().children(e.treeviewMenu).length; tm++) { 
                b.parent().children(e.treeviewMenu).eq(tm).slideUp(this.options.animationSpeed, function() {
                    b.find(e.open + " > " + e.treeview).slideUp(), a(this.element).trigger(d)
                }.bind(this))
            }
        }
